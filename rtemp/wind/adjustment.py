...
class WindAdjustment:
    ...
    def adjust_for_height(
        ...
        height_ratio = target_height / measured_height
        adjusted_wind = wind_speed * (height_ratio ** WindAdjustment.TVA_EXPONENT)
        
        return adjusted_wind
    
    @staticmethod
    def apply_shelter_factor(
        wind_speed: float,
    ...
    def adjust_with_shelter(
        ...
        final_wind = WindAdjustment.apply_shelter_factor(
            height_adjusted, effective_wind_factor
        )
