...
class TestShadeCorrection:
    ...
    def test_no_shade_no_correction(self):
        ...
        radiation = 1000.0
        result = SolarRadiationCorrections.apply_shade_correction(
            radiation, effective_shade=0.0
        )
        assert result == radiation
    ...
    def test_partial_shade_linear_reduction(self):
        ...
        result_50 = SolarRadiationCorrections.apply_shade_correction(
            radiation, effective_shade=0.5
        )
...
class TestAlbedoCorrection:
    ...
    def test_zero_albedo_no_correction(self):
        ...
        radiation = 1000.0
        result = SolarRadiationCorrections.apply_albedo_correction(
    ...
    def test_partial_albedo_linear_reduction(self):
        ...
        result_10 = SolarRadiationCorrections.apply_albedo_correction(
            radiation, albedo=0.1
        )
        result_50 = SolarRadiationCorrections.apply_albedo_correction(
            radiation, albedo=0.5
        )
