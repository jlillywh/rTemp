...
class TestAtmosphericHelpers:
    ...
    def test_dewpoint_from_rh_100_percent(self):
        ...
        assert abs(dewpoint - air_temp) < 0.1, (
    ...
    def test_pressure_from_altitude_sea_level(self):
        ...
        assert abs(pressure - 1013.25) < 0.01, (
            f"Expected 1013.25 mb at sea level, got {pressure}"
        )
    ...
    def test_koberg_brunt_coefficient_with_clearness(self):
        ...
        assert coeff_clear < coeff_cloudy, (
            "Clear skies should have lower coefficient than cloudy"
        )
    ...
    def test_koberg_brunt_coefficient_temperature_effect(self):
        ...
        assert coeff_warm > coeff_cold, (
            "Warmer temperatures should have higher coefficient"
        )
...
class TestLongwaveRadiation:
    ...
    def test_calculate_atmospheric_overcast(self):
        ...
        longwave_clear = LongwaveRadiation.calculate_atmospheric(
            emissivity, air_temp_c, 0.0
        )
        ...
        assert longwave_overcast > longwave_clear, (
    ...
    def test_calculate_atmospheric_temperature_effect(self):
        ...
        longwave_cold = LongwaveRadiation.calculate_atmospheric(
            emissivity, 0.0, cloud_cover
        )
        longwave_warm = LongwaveRadiation.calculate_atmospheric(
            emissivity, 30.0, cloud_cover
        )
        
        # Warmer air should produce more longwave radiation
        assert longwave_warm > longwave_cold, (
            "Warmer air should produce more longwave radiation"
        )
    ...
    def test_calculate_atmospheric_emissivity_effect(self):
        ...
        longwave_low_emiss = LongwaveRadiation.calculate_atmospheric(
            0.6, air_temp_c, cloud_cover
        )
        longwave_high_emiss = LongwaveRadiation.calculate_atmospheric(
            0.9, air_temp_c, cloud_cover
        )
        
        # Higher emissivity should produce more longwave radiation
        assert longwave_high_emiss > longwave_low_emiss, (
            "Higher emissivity should produce more longwave radiation"
        )
    ...
    def test_calculate_atmospheric_reflection_reduction(self):
        ...
        assert abs(longwave - expected_with_reflection) < 0.1, (
    ...
    def test_calculate_back_radiation_temperature_effect(self):
        ...
        assert back_warm > back_cold, (
            "Warmer water should emit more back radiation"
        )
    ...
    def test_calculate_back_radiation_stefan_boltzmann(self):
        ...
        # Should match within small tolerance
        assert abs(back_radiation - expected) < 0.1, (
            f"Expected {expected}, got {back_radiation}"
        )
    ...
    def test_calculate_back_radiation_negative_temperature(self):
        ...
        assert back_radiation < back_0c, (
            "Back radiation at -5°C should be less than at 0°C"
        )
