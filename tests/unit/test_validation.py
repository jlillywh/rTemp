...
class TestMeteorologicalDataValidation:
    ...
    def test_missing_air_temperature_corrected(self):
        ...
        data = pd.DataFrame(
            {"air_temperature": [20.0, -999.0, -1000.0], "dewpoint_temperature": [15.0, 16.0, 17.0]}
        )
    ...
    def test_missing_dewpoint_corrected(self):
        ...
        data = pd.DataFrame(
            {"air_temperature": [20.0, 22.0, 24.0], "dewpoint_temperature": [15.0, -999.0, -1000.0]}
        )
    ...
    def test_negative_wind_speed_corrected(self):
        ...
        data = pd.DataFrame({"wind_speed": [2.0, -1.0, 3.0, -0.5]})
    ...
    def test_negative_cloud_cover_corrected(self):
        ...
        data = pd.DataFrame({"cloud_cover": [0.3, -0.1, 0.5, -0.2]})
    ...
    def test_excessive_cloud_cover_corrected(self):
        ...
        data = pd.DataFrame({"cloud_cover": [0.3, 1.5, 0.5, 2.0]})
