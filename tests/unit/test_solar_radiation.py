...
class TestRyanStolzSolarRadiation:
    ...
    def test_ryan_stolz_noon_summer(self):
        ...
        assert 0 < radiation < 1367, \
            f"Expected radiation between 0 and 1367 W/m², got {radiation}"
        
        # For 60° elevation, should be substantial radiation
        assert radiation > 500, \
            f"Expected substantial radiation at 60° elevation, got {radiation}"
    ...
    def test_ryan_stolz_low_sun(self):
        ...
        assert 0 < radiation < 500, \
            f"Expected lower radiation at 15° elevation, got {radiation}"
    ...
    def test_ryan_stolz_below_horizon(self):
        ...
        assert radiation == 0.0, \
            f"Expected zero radiation below horizon, got {radiation}"
    ...
    def test_ryan_stolz_at_horizon(self):
        ...
        assert radiation == 0.0, \
            f"Expected zero radiation at horizon, got {radiation}"
...
class TestIqbalSolarRadiation:
    ...
    def test_iqbal_noon_summer(self):
        ...
        assert abs(result['global_hz'] - (result['direct_hz'] + result['diffuse_hz'])) < 0.1, \
            "Global should equal direct + diffuse"
        
        # Should have substantial radiation at high sun angle
        assert result['global_hz'] > 500, \
    ...
    def test_iqbal_diffuse_components_sum(self):
        ...
        diffuse_sum = (result['diffuse_rayleigh'] + 
