...
print(f"  Error vs VBA: {abs(evap_1_w_m2 - vba_evap):.4f} W/m² ({abs(evap_1_w_m2 - vba_evap) / abs(vba_evap) * 100:.1f}%)")
print()
...
print(f"  Error vs VBA: {abs(evap_2_w_m2 - vba_evap):.4f} W/m² ({abs(evap_2_w_m2 - vba_evap) / abs(vba_evap) * 100:.1f}%)")
print()
...
if abs(evap_2_w_m2 - vba_evap) < abs(evap_1_w_m2 - vba_evap):
    ...
    print(f"  Error reduced from {abs(evap_1_w_m2 - vba_evap):.2f} to {abs(evap_2_w_m2 - vba_evap):.2f} W/m²")
else:
