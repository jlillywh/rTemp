...
@given(
    water_depth=st.floats(min_value=-1000, max_value=0, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    wind_height=st.floats(min_value=-1000, max_value=0, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    effective_wind_factor=st.floats(min_value=-1000, max_value=-0.001, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    groundwater_temperature=st.floats(min_value=-1000, max_value=-0.001, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    groundwater_inflow=st.floats(min_value=-1000, max_value=-0.001, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    sediment_thermal_conductivity=st.floats(min_value=-1000, max_value=-0.001, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    sediment_thermal_diffusivity=st.floats(min_value=-1000, max_value=0, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    sediment_thickness=st.floats(min_value=-1000, max_value=0, allow_nan=False, allow_infinity=False)
)
...
# Validates: Requirements 8.1-8.15
@given(
    hyporheic_exchange_rate=st.floats(min_value=-1000, max_value=-0.001, allow_nan=False, allow_infinity=False)
)
...
def test_property_multiple_missing_data_handled(n_rows, air_temp_missing_prob, 
                                                dewpoint_missing_prob, wind_negative_prob,
                                                cloud_invalid_prob):
    """
    Property 16: Missing Data Handling
    ...
    dewpoint_temps = [-999.0 if random.random() < dewpoint_missing_prob else 15.0 for _ in range(n_rows)]
    ...
    assert all((validated['dewpoint_temperature'] == 10.0) | (validated['dewpoint_temperature'] == 15.0))
    assert all(validated['wind_speed'] >= 0.0)
